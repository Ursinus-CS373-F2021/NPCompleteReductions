...
public class HamiltonianPath extends NPCompleteProblem {

    private int N; // Number of vertices
    private ArrayList<int[]> edges; // List of undirected edges
    private HashSet<String> edgeSet; // A redundant dataset for easy lookup of edges
